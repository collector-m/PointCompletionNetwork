...
if __name__ == '__main__':
    ...
    parser.add_argument('--lmdb_train', default='/home/zq/zq/git-space/pcn/render/output_exr_1/lmdb_output/train.lmdb')
    parser.add_argument('--lmdb_valid', default='/home/zq/zq/git-space/pcn/render/output_exr_1/lmdb_output/valid.lmdb')
    parser.add_argument('--log_dir', default='log/pcn_emd')
    parser.add_argument('--model_type', default='pcn_emd')
    parser.add_argument('--restore', action='store_true')
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--num_input_points', type=int, default=40000)
    parser.add_argument('--num_gt_points', type=int, default=100000)#16384
    ...
    train(args)
# python lmdb_writer.py --list_path /home/zq/zq/git-space/pcn/render/output_exr_1/lmdb_output/train.txt --num_scans 3 \
#                                                                                                                   --partial_dir /home/zq/zq/git-space/pcn/render/output_exr_1/pcd  \
#                                                                                                                   --complete_dir /home/zq/zq/git-space/pcn/data/data_preprocess/chair_pcd \
#                                                                                                                   --output_path /home/zq/zq/git-space/pcn/render/output_exr_1/lmdb_output/train